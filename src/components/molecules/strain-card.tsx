...
export const StrainCard: React.FC<StrainCardProps> = ({ strain, selected, onSelect }) => {
    ...
    useLayoutEffect(() => {
        const update = () => {
            ...
            const cx = (((tRect.left + tRect.right) / 2 - rRect.left) / rRect.width) * 100;
            const cy = (((tRect.top + tRect.bottom) / 2 - rRect.top) / rRect.height) * 100;
    ...
    return (
        ...
        >
            ...
            {supportsBackdrop ? <div aria-hidden style={overlayStyle} /> : <div aria-hidden style={fallbackStyle} />}
            <div className="position-relative" style={{ zIndex: 2 }}>
                ...
                <div ref={textRef}>
                    ...
                    <div className="mt-3">
                        ...
                        >
                            <div className="ratio-bar thc" style={{ borderRadius: "999px 0 0 999px" }} />
                            <div className="ratio-bar cbd" style={{ borderRadius: "0 999px 999px 0" }} />
                        </div>
                        <div
